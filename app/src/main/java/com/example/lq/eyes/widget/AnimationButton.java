package com.example.lq.eyes.widget;
...
/**
 * Created by darryrzhong on 2018/6/29.
 * 带动画效果的按钮
 */
...
public class AnimationButton extends View {
     ...
     * 背景颜色
     */
    private int bg_color =getResources().getColor(R.color.colorAniBtn);
    /**
     * 按钮文字字符串
     */
    private String buttonString = "确认提交";
    /**
     * 动画执行时间
     */
